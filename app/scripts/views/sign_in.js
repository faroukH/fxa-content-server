  ...
  var View = FormView.extend({
    ...
    _suggestedAccountAskPassword: function (account) {
      ...
      if (! account.get('email')) {
        this.logScreenEvent('ask-password.shown.no-account');
        return true;
      }
      ...
      if (this.relier.wantsKeys()) {
        this.logScreenEvent('ask-password.shown.wants-keys');
        return true;
      }
      ...
      if (! this.user.isSyncAccount(account)) {
        this.logScreenEvent('ask-password.shown.non-sync-account');
        return true;
      }
      ...
      if (this.chooserAskForPassword === true) {
        this.logScreenEvent('ask-password.shown.expired-session');
        return true;
      }
